...
{
    public class PersonelManager:ServiceRepository<Personel,IPersonelDal,PersonelValidator>,IPersonelService
    {
        public PersonelManager(IPersonelDal x, PersonelValidator y) :base(x,y)
        {

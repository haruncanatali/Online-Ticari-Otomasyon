...
{
    public class FaturaKalemManager:ServiceRepository<FaturaKalem,IFaturaKalemDal,FaturaKalemValidator>,IFaturaKalemService
    {
        public FaturaKalemManager(IFaturaKalemDal x, FaturaKalemValidator y) :base(x,y)
        {

...
{
    public class MusteriManager:ServiceRepository<Musteri,IMusteriDal,MusteriValidator>,IMusteriService
    {
        public MusteriManager(IMusteriDal x, MusteriValidator y) :base(x,y)
        {
